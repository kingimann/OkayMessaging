// PASTE-READY, self-contained version of iap-notify for the Supabase
// Dashboard editor (Edge Functions -> Deploy a new function -> Via Editor).
// Name the function EXACTLY: iap-notify
//
// GENERATED by tool/paste_functions.dart — do not edit by hand. It is the
// logic of supabase/functions/iap-notify/index.ts with the _shared/
