// PASTE-READY, self-contained version of turn-credentials for the Supabase
// Dashboard editor (Edge Functions -> Deploy a new function -> Via Editor).
// Name the function EXACTLY: turn-credentials
//
// GENERATED by tool/paste_functions.dart — do not edit by hand. It is the
// logic of supabase/functions/turn-credentials/index.ts with the _shared/
