// PASTE-READY, self-contained version of creator-subscribe for the Supabase
// Dashboard editor (Edge Functions -> Deploy a new function -> Via Editor).
// Name the function EXACTLY: creator-subscribe
//
// GENERATED by tool/paste_functions.dart — do not edit by hand. It is the
// logic of supabase/functions/creator-subscribe/index.ts with the _shared/
