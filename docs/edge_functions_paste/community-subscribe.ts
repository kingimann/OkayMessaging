// PASTE-READY, self-contained version of community-subscribe for the Supabase
// Dashboard editor (Edge Functions -> Deploy a new function -> Via Editor).
// Name the function EXACTLY: community-subscribe
//
// GENERATED by tool/paste_functions.dart — do not edit by hand. It is the
// logic of supabase/functions/community-subscribe/index.ts with the _shared/
